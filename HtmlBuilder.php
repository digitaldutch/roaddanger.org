...
class HtmlBuilder {
  ...
  public static function getHTMLBeginMain(string $pageTitle='', string $head='', string $initFunction='',
      bool $showButtonAdd=false): string {
    global $VERSION;
...
HTML;
  ...
  public static function getNavigation(): string {
    ...
    $texts = translateArray(['Admin', 'Crashes', 'Statistics', 'Translations', 'Long_texts', 'Other', 'Recent_crashes',
      ...
      'Version', 'Questionnaires', 'Questionnaire_answers', 'Setup', 'Results', 'AI_prompt_builder', 'AI_tasks', 'Research',
  ...
  <div style="overflow-y: auto;">
    ...
    <div id="navigationAdmin" data-moderator>    
      ...
      <div class="navigationSection">
        ...
        <a href="/research/questionnaires/answer" class="navItem" data-admin>{$texts['Questionnaire_answers']}</a>
...
<div id="pageMain">
  ...
  <div id="filterBar" class="filterBar filterBarTransparent" style="display: flex; padding-bottom: 0;">
...
HTML;
  ...
  public static function pageRecent($pageType): string {
